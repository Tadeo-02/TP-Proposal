...
### Repositorio
https://github.com/Tadeo-02/Barbershop

## Tema
### Descripción
Sistema de gestión de turnos de una barbería que cuenta con varias sucursales y barberos. El sistema deberá registrar a los clientes quienes podrán solicitar turnos con los diferentes barberos. Por otro lado, el barbero será capaz de gestionar los turnos solicitados, modificandolos o cancelandolos. Los clientes tendrán diferentes categorías que les permitirán acceder a descuentos, y para eso se llevará un historial de todos los turnos solicitados por cada cliente. El sistema ofrecerá la opción de realizar una factura del corte efectuando mediante ARCA.
...
|CUU/Epic|1. Reservar Turno<br>2. Modificar Turno<br>3. Realizar Factura|
...
|Req|Detalle|
|:-|:-|
|Listados |1. Listado de historial de cortes para clientes<br>2. Listado de historial de cortes de barberos para admin|
